...
FCKConfig.Plugins.Add('screencapture', 'zh-cn');
...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Cut','Copy','Paste','PasteText','imagepaster','netpaster','screencapture'],
...
FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','About','imagepaster','netpaster','screencapture']
];
